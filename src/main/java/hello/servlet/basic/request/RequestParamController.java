...
public class RequestParamController {
    ...
    /**
     * 반환 타입이 없으면서 이렇게 응답에 직접 값을 집어넣으면, view 조회X
     */
    ...
    // Controller에서 return "ok"를 하면 ok이름을 가진 view를 찾음
    // 즉 RestController가 필요
    // RestController 사용하면 다 바뀌니 대신에
    // @ResponseBody 를 사용할 수 있음
    @ResponseBody
